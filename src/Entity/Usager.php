...
class Usager extends Personne implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[Assert\NotBlank(message: "Merci de saisir l'email!")]
    #[Groups('usager:read')]
    private $email;
    ...
    #[ORM\Column(type: 'string', length: 50)]
    #[Assert\NotBlank(message: "Niveau est obligatoire !")]
    #[Groups('usager:read')]
    private $niveau;

    #[ORM\Column(type: 'string', length: 50)]
    #[Assert\NotBlank(message: "Loisir est obligatoire !")]
    #[Groups('usager:read')]
    private $loisir;

    #[ORM\Column(type: 'string', length: 100)]
    #[Assert\NotBlank(message: "Adresee est obligatoire !")]
    #[Groups('usager:read')]
    private $adresse;
    ...
    #[Assert\NotBlank(message: "Code postale est obligatoire !")]
    #[Groups('usager:read')]
    private $cp;

    #[ORM\ManyToOne(targetEntity: Quartier::class, inversedBy: 'usagers')]
    #[ORM\JoinColumn(nullable: false)]
    #[Assert\NotBlank(message: "Quartier est obligatoire !")]
    #[Groups('usager:read')]
    private $quartiers;
    ...
    #[Assert\NotBlank(message: "Sexe est obligatoire !")]
    #[Groups('usager:read')]
    private $genre;
